...
import numpy as np
from Vision.Main.NetworkTableHandler import NetworkTableHandler
import sys
...
if __name__ == '__main__':
    ...
    vision = Vision(stream.get(cv2.CAP_PROP_FRAME_WIDTH), stream.get(cv2.CAP_PROP_FRAME_HEIGHT), 30, ntHandler)
